...
export function HeroSection() {
  ...
  return (
    <section
      id="inicio"
      className="relative overflow-hidden bg-background pt-[72px] lg:pt-[80px]"
    >
      <div className="container-vieg grid items-center gap-12 py-14 md:py-20 lg:min-h-[660px] lg:grid-cols-[1fr_1.08fr] lg:gap-16 lg:py-24">
          ...
          <Reveal delay={330}>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
              <a
                ...
                className="vieg-button inline-flex items-center justify-center rounded-full bg-accent px-8 py-3.5 font-body text-sm font-medium text-accent-foreground shadow-[var(--shadow-soft)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary"
              >
                {t.hero.primary}
              </a>
              ...
              <a
                href="#servicos"
                className="vieg-button inline-flex items-center justify-center rounded-full border border-primary/40 px-8 py-3.5 font-body text-sm font-medium text-primary transition-all duration-300 hover:-translate-y-0.5 hover:border-primary hover:bg-primary hover:text-primary-foreground"
              >
                {t.hero.secondary}
              </a>
            </div>
        ...
        <Reveal delay={430} className="relative">
          <ImagePlaceholder
